...
const audio_video_black_path = "../assets/img/new_black.mov";
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  $("video#recording-label-black").on("click", function() {
    ...
    if (isRecognitionStarted) {
      clearInfoDisplay();
      displayStopRecordingMessage();
      loadAndPlayVideo(audio_element_black, audio_video_black_path);
      speechRecognition.start();
    } else {
      clearInfoDisplay();
      $(audio_element_black)[0].pause();
      $(audio_element_black)[0].currentTime = 0;
      speechRecognition.stop();
    }
  });
...
// -------------- DEBUG MODE ------------------
  ...
  // for more answer questions.
    ...
    inputBox.elt.value = "yes yes yes yes yes";
